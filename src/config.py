...
PROMPT_TEMPLATES = {
    ...
    'common_sense': {
        ...
        'C4_HasPart': 'Fill the blank (one word): A {subject} has a ____.',
        'C5_AtLocation': 'Fill the blank (one word): You usually find a {subject} in the ____.',
        'C6_CapableOf': 'Fill the blank (one word): A {subject} can ____.',
        'C7_UsedBy': 'Fill the blank (one word): A {subject} is used by a ____.',
        'C8_Requires': 'Fill the blank (one word): A {subject} requires ____.',
        'C9_Contains': 'Fill the blank (one word): A {subject} contains ____.',
        'C10_WornOn': 'Fill the blank (one word): A {subject} is worn on the ____.',
    },
